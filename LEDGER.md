...
| **Two reserved interface slots are load-bearing**: `__gaInterfaceReserved[0] = vmWaitSurface`, `[1] = vmSetSurface` — Apple's CGS calls these through the reserved slots of `IOGraphicsAcceleratorInterface`; a reimplementation must fill them | `GA/VMsvga2GA.cpp:1109-1110` |
